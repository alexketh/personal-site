...
Welcome to my [personal website]([https://mldangelo.com](https://alexketh.github.io/personal-site/))! This is a React-based Jamstack application. It offers a simple interface, easy modifications, static export capabilities, and free automatic deployments via [GitHub Pages](https://pages.github.com/).
...
1. Clone the repository:
   ...
   ```bash
   git clone git://github.com/alexketh/personal-site.git
   cd personal-site
   ```
...
- Initial template from [Michael D'Angelo](https://mldangelo.com) by [@mldangelo](https://github.com/mldangelo).
